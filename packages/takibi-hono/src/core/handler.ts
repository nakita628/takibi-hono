...
/**
 * Collects all operations from the OpenAPI spec and groups them by the first path segment.
 */
export function collectOperations(openapi: OpenAPI): ReadonlyMap<string, readonly OperationInfo[]> {
...
/**
 * Generates a complete handler file for a group of operations.
 */
